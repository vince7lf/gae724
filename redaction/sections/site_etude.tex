...
\begin{figure}[H]
    ...
    \caption{}
    \caption[Caption for LOF]{Vue aérienne du pont Jacques-Cartier (flickr PJCCI)\protect\footnotemark.}
    \label{fig:pjcci_vueaerienne}
\end{figure}
\footnotetext{https://www.flickr.com/photos/pjcci/6830109134}
...
\begin{figure}[H]
    ...
    \caption{Carte du site d'implantation : le pont Jacques-Cartier et la piste multifonctionnelle en orange sur le pont (OpenStreetMap).}
...
\begin{figure}[H]
    ...
    \caption[Caption for LOF]{Schéma de la configuration de la piste multifonctionnelle (PJCCI)\protect\footnotemark.}
    \label{fig:Fiche_piste-multi_pont_JC_FR_vfinale_2018-10-10}
\end{figure}
\footnotetext{https://jacquescartierchamplain.ca/wp-content/uploads/2018/10/IMG\_Fiche\_piste-multi\_pont\_JC\_FR\_vfinale\_web\_\_2018-10-10.pdf}