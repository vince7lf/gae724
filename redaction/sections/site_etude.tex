...
\begin{figure}[H]
    ...
    \caption[représentation cartographique du site d'implantation]{Description de la zone géographique du site d'implantation : le pont Jacques-Cartier et la piste multifonctionnelle en orange sur le pont (copie-écran OpenStreetMap).}
