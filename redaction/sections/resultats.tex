...
\begin{figure}[H]
   \centering
   \includegraphics[width=0.75\textwidth]{b1-09517_Clipped.jpg}
...
\begin{figure}[H]
   ...
   \caption{Image originale b1-09517}
   \label{fig:b1-09517_Clipped}
\end{figure}
{
   \centering
...
\begin{figure}[H]
   \centering
   \includegraphics[width=0.75\textwidth]{b378-61_Clipped.jpg}
   \caption{Image originale b378-61}
