...
% \end{figure}
% \noindent Si chacun des blocs est explosé, chacun d'eux s'organise autour des activités suivantes: 
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{methodologie_complexe}
...
% \end{figure}
% \noindent Mais dans la réalité la méthodologie ressemblera plus à celle-ci:
