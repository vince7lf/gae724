...
\par Les changements les plus récents apparaissent en premier. 
{
    ...
    % \begin{tabular}{|c|c|c|} % does not work don't know why
        ...
        \hline
        v1.1 & 18 juillet 2020 & \begin{itemize}
            \item Ajout d'une section changelog pour documenter le suivi des changement et faciliter la révision.
            \item Apport de clarification dans la section Matériel \& logiciels (hdparm, présentaion SDK, etc). 
