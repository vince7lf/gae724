...
\par Un script Python\footnote{\url{https://gist.github.com/ilmonteux/8340df952722f3a1030a7d937e701b5a}} est utilisé afin de mesurer le IoU et le Z-Score de la classe de l'image prédite par le modèle.