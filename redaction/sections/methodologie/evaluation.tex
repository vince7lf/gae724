...
\begin{itemize}
    ...
    \begin{itemize}
        \item Les performances matérielles durant l'inférence sont évaluées grâce aux indicateurs fournies par les utilitaires 'Tegrastats' de NVIDIA, 'free' et 'iotop'. Ces utilitaires sont brièvement décrit dans le tableau \ref{table:table_sol_logiciel}.
