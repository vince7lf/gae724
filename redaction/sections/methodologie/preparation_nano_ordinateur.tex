...
\mysubparagraph{Micro SD}
{
    ...
    \begin{tabular}{l}
        \includegraphics[width=0.15\textwidth]{micro_sd_evo_plus} MicroSD card Samsung EVO 64Gb Plus XC I Grade 3 Class 10\\
        \includegraphics[width=0.15\textwidth]{micro_sd_evo} MicroSD card Samsung EVO 64Gb Select XC I Grade 3 Class 10\\
        \includegraphics[width=0.15\textwidth]{Microsd card Scan Disk Ultra 32Gb class 10 HC I} MicroSD card Scan Disk Ultra 32Gb HC I Class 10\\
    \end{tabular}
    \end{table}
}
{\color{red}\todo{TODO}}
