...
\par La première fois que le système démarre, le système Ubuntu "\acrlong{l4t}" (\acrshort{l4t}) doit être configuré avec toutes les options personnalisées (langue, clavier, fuseau horaire, etc.).
