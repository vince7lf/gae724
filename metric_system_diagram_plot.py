# -*- coding: utf-8 -*-
"""metric-system-diagram-plot.ipynb
...
df = pd.read_csv('/content/1sttime/free-20200722T194157.log.csv')
df.head()
...
data = np.loadtxt('/content/1sttime/free-20200722T194157.log.csv', delimiter=',', skiprows=1)
...
df = pd.read_csv('/content/1sttime/tegrastats-20200722T194157.log.48.csv')
df.head()
...
df = pd.read_csv('/content/1sttime/iotop-20200722T194157.log.totaldisk.csv')
df.head()
...
df = pd.read_csv('/content/1sttime/iotop-20200722T194157.log.segnet-camera.csv')
df.head()
